...
<head>
    ...
    <title>Dernek Yönetim Otomasyonu</title>
...
<div id="topbar" class="d-none d-lg-flex align-items-center fixed-top ">
    <div class="container d-flex align-items-center">
        <div class="contact-info mr-auto">
            <ul>
                <li><i class="icofont-envelope"></i><a href="mailto:contact@example.com">info@dernekmaili.com</a></li>
                <li><i class="icofont-phone"></i> +90 850 000 00 00</li>
                <li><i class="icofont-clock-time icofont-flip-horizontal"></i> Pazartesi-Cuma 09:00-17:00</li>
            </ul>
        </div>
        <div class="cta">
            <a href="{{route("login")}}" class="scrollto">Giriş Yap</a>
        </div>
    </div>
</div>
...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="#header" class="scrollto">Dernek</a></h1>
