    ...
    <div class="grid grid-cols-12 gap-6 mt-8">
        <div class="col-span-12 lg:col-span-3 xxl:col-span-2">
            ...
            <div class="intro-y box p-5 mt-6">
                <div class="mt-1">
                    <a href="" class="flex items-center px-3 py-2 rounded-md bg-theme-1 text-white font-medium">  <i class="w-4 h-4 mr-2" data-feather="file"></i> Dosyalar </a>
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md"> <i class="w-4 h-4 mr-2" data-feather="video"></i> Videolar </a>
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md"><i class="w-4 h-4 mr-2" data-feather="image"></i> Fotoğraflar </a>
                </div>
            </div>
        ...
        <div class="col-span-12 lg:col-span-9 xxl:col-span-10">
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                <div class="w-full sm:w-auto relative mr-auto mt-3 sm:mt-0">
                    ...
                    <input type="text" class="input w-full sm:w-64 box px-10 text-gray-700 placeholder-theme-13" placeholder="Dosyalarda Ara">
                            ...
                            <div class="dropdown-box__content box p-5">
                                <div class="grid grid-cols-12 gap-4 row-gap-3">
                                    <div class="col-span-6">
                                        <div class="text-xs">Dosya Adı</div>
                                        <input type="text" class="input w-full border mt-2 flex-1" placeholder="Dosya adınızı giriniz">
                                    </div>
                                    <div class="col-span-6">
                                        <div class="text-xs">Gönderen</div>
                                        <input type="text" class="input w-full border mt-2 flex-1" placeholder="Gönderen kişiyi yazınız">
                                    </div>
                                    <div class="col-span-12 flex items-center mt-3">
                                        <button class="button w-32 justify-center block bg-gray-200 text-gray-600 ml-auto">Create Filter</button>
                                        <button class="button w-32 justify-center block bg-theme-1 text-white ml-2">Ara</button>
                                    </div>
                                </div>
                            </div>
                        </div>
