...
<head>
    ...
    <title>Giriş Yap - Dernek Otomasyonu</title>
    <!-- BEGIN: CSS Assets-->
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                <div class="intro-x mt-8">
                    <input type="text" class="intro-x login__input input input--lg border border-gray-300 block" id="email" name="email" value="{{old("email")}}" placeholder="Email">
                    <input type="password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" id="password" name="password" placeholder="Şifre" required autocomplete="current-password">
                </div>
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    ...
                    <button class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 mt-3 xl:mt-0"><a href="{{route("register")}}">Üye Ol</a></button>
                </div>
                <div class="intro-x mt-10 xl:mt-24 text-gray-700 text-center xl:text-left">
                    Giriş yaparak aşağıdakileri kabul etmiş sayılırsınız :
                    <br>
                    <a class="text-theme-1" href="">Şartlar ve Koşullar</a> & <a class="text-theme-1" href="">Gizlilik Politikası</a>
                </div>
